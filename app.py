...
st.set_page_config(
    page_title="포켓몬 도감",
    page_icon="streamlit-pokemon/images/monsterball.png"
)
...
print("page_reload, auto_comlete", auto_complete)
    ...
    if submit:
        if not name:
           ...
           st.session_state.pokemons.append({
               "name": name,
               "types": types,
               "image_url": image_url if image_url else "streamlit-pokemon/images/default.png",
           })
